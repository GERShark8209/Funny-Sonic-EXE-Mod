...
class ChartingState extends MusicBeatState
{
	...
	var eventStuff:Array<Dynamic> = [
		...
		['Toggle Freestyle', 'Toggle The Parappa Freestyle Thing']
	];
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var check_parappaSong = new FlxUICheckBox(10, 50, null, null, "Parappa Song", 100);
		check_parappaSong.checked = _song.parappaSong;
		check_parappaSong.callback = function()
		{
			_song.parappaSong = check_parappaSong.checked;
		};
		...
		tab_group_song.add(check_parappaSong);
